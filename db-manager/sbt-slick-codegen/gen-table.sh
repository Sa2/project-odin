...
[ ! -e ../../application/odin-auth-service/app/$dir ] && mkdir -p ../../application/odin-auth-service//app/$dir
...
cp target/scala-2.11/src_managed/main/models/dao/Tables.scala ../../application/odin-auth-service/app/models/dao/
